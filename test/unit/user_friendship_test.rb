...
class UserFriendshipTest < ActiveSupport::TestCase
  ...
  test "that creating a friendship based in user_id and friend_id works" do
  ...
  #if a method has a '!' in the end, it means it is potentially dangerous!
  context "#accept!" do 
    setup do
    ...
    should "include friend in the list of friends" do
      @user_friendship.accept!
